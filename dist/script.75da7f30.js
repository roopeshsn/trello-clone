...
// selectors
var addList = document.querySelector(".btn-add-list");
var addListInputContainer = document.querySelector(".add-list-input-container");
var btnAddList = document.querySelector(".btn-add-list-2");
var lanesContainer = document.querySelector(".lanes");
var btnClose = document.querySelector(".btn-close");
var addNewListInput = document.querySelector(".add-list-input");
...
(0, _addGlobalEventListener.default)("submit", "[data-add-new-list-form]", function (e) {
  e.preventDefault();
  var listTitle = addNewListInput.value;
  if (listTitle === "") return;
  var laneTitle = listTitle.trim();
  var dataLaneId = laneTitle.toLowerCase().split(" ").join("");
  var laneName = "".concat(dataLaneId);
  var listElement = createLaneElement(laneTitle, dataLaneId);
  lanesContainer.insertAdjacentHTML("beforeend", listElement);
  console.log(listElement); // lanesContainer.append(listElement);
...
function renderLanes() {
  Object.entries(lanes).forEach(function (obj) {
    var laneId = obj[0];
    var laneTitle = capitalizeFirstLetter(laneId);
    var laneElement = createLaneElement(laneTitle, laneId);
...
function createLaneElement(laneTitle, dataLaneId) {
  var element = "\n      <div class=\"lane\" data-lane-name=\"".concat(dataLaneId, "\">\n        <div class=\"header\">").concat(laneTitle, "</div>\n        <div class=\"tasks\" data-drop-zone data-lane-id=\"").concat(dataLaneId, "\"></div>\n        <form data-task-form>\n          <input data-task-input class=\"task-input\" type=\"text\" placeholder=\"Add another card\" />\n        </form>\n      </div>");
  return element;
}
